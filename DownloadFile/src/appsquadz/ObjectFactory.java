 ...
 * generated in the appsquadz package. 
...
public class ObjectFactory {
    ...
    private final static QName _DownloadFile_QNAME = new QName("http://appsquadz/", "downloadFile");
    private final static QName _DownloadFileResponse_QNAME = new QName("http://appsquadz/", "downloadFileResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: appsquadz
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://appsquadz/", name = "downloadFile")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://appsquadz/", name = "downloadFileResponse")
